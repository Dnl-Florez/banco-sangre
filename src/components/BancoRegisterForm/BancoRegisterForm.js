...
import './BancoRegisterForm.css'

function BancoRegisterForm (){
  const { 
    setOpenModal,
  ...
  return(
    <form className='register-form'>
      	<label className='form-title2'>Registrarse</label>
	...
	<input 
	  ...
	  name='cantdon' 
	/>
	<a className='text-usuario'>Usuario:</a>
	<input 
	  className='input-usuario' 
	  name='usuario' 
	/>
	<a className='text-contrasena'>Contraseña:</a>
      	<input 
	...
	/>
      	...
      	<button
	  className='boton-ingresar2'
	  type='submit'
      	> Ingresar </button>
	<div>
	<button 
	  className='boton-cancelar2'
	  type='exit'
	  onClick={onCancel}
      	>Cancelar</button>
	</div>
